...
public class UsernameNotFoundException extends AbstractThrowableProblem {
    ...
    public UsernameNotFoundException(ErrorEnum error) {
        this(ErrorConstants.DEFAULT_TYPE, error.getMessage(), error.getEntityName(), error.getErrorKey());
    }

    public UsernameNotFoundException(ErrorEnum error, Object data) {
        this(ErrorConstants.DEFAULT_TYPE, error.getMessage(), error.getEntityName(), error.getErrorKey(), data);
    }

    public UsernameNotFoundException(String defaultMessage, String entityName, String errorKey) {
        this(ErrorConstants.DEFAULT_TYPE, defaultMessage, entityName, errorKey);
    }

    public UsernameNotFoundException(URI type, String defaultMessage, String entityName, String errorKey) {
        super(type, defaultMessage, Status.UNAUTHORIZED, null, null, null, getAlertParameters(entityName, errorKey, null));
        this.entityName = entityName;
        this.errorKey = errorKey;
    }

    public UsernameNotFoundException(URI type, String defaultMessage, String entityName, String errorKey, Object data) {
        super(type, defaultMessage, Status.UNAUTHORIZED, null, null, null, getAlertParameters(entityName, errorKey, data));
        this.entityName = entityName;
        this.errorKey = errorKey;
    }
